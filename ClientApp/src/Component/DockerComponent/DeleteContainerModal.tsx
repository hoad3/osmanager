...
const DeleteContainerModal: React.FC<DeleteContainerModalProps> = ({ isOpen, onClose, onSubmit }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-gray-900 p-6 rounded-2xl w-3/4 max-w-3xl">
                <h2 className="text-xl font-bold text-white mb-4">Xóa Container</h2>

                {/* Folder selection */}
                <div className="mb-4 border border-gray-700 rounded-lg p-2 bg-gray-800">
                    <span className="text-gray-300 mb-1 block">Chọn thư mục chứa container:</span>
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button
                        ...
                        disabled={loading}
                    >
                        {loading ? "Đang xóa..." : "Xóa Container"}
                    </button>
                </div>
            </div>
        </div>
